<div class="span3" id="sidebar">
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			...
			<!-- sidebar for student's account. Videos, Games, Backpack -->

			<li class="active">
			<a href="backpack.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Backpack</a></li>
			</li>

			<li class="">
			<a href="videos.php"><i class="icon-chevron-right"></i><i class="icon-play"></i>&nbsp;Videos</a></li>
			 
			<li class="">
			<a href="games.php"><i class="icon-chevron-right"></i><i class="icon-flag"></i>&nbsp;Games</a></li>
